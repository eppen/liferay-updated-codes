 ...
 * {@link userapi.service.impl.unitLocalServiceImpl} and is the
...
public class unitLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link userapi.service.impl.unitLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<userapi.model.unit> getunits(int start, int end) {
	...
	*/
	public static userapi.model.unit addunit(userapi.model.unit unit) {
	...
	* @return the new unit
	*/
	public static userapi.model.unit createunit(int unit_id) {
		return getService().createunit(unit_id);
	}
	...
	*/
	public static userapi.model.unit deleteunit(int unit_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteunit(unit_id);
	}
	...
	* @return the unit that was removed
	*/
	public static userapi.model.unit deleteunit(userapi.model.unit unit) {
		return getService().deleteunit(unit);
	}

	public static userapi.model.unit fetchunit(int unit_id) {
		return getService().fetchunit(unit_id);
	}
	...
	* @throws PortalException if a unit with the primary key could not be found
	*/
	public static userapi.model.unit getunit(int unit_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getunit(unit_id);
	}
	...
	*/
	public static userapi.model.unit updateunit(userapi.model.unit unit) {
	...
	private static ServiceTracker<unitLocalService, unitLocalService> _serviceTracker =
		ServiceTrackerFactory.open(unitLocalService.class);
}