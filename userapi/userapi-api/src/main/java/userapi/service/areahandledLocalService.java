...
/**
 * Provides the local service interface for areahandled. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see areahandledLocalServiceUtil
...
public interface areahandledLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link areahandledLocalServiceUtil} to access the areahandled local service. Add custom service methods to {@link userapi.service.impl.areahandledLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
