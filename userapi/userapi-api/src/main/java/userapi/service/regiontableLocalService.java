...
/**
 * Provides the local service interface for regiontable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see regiontableLocalServiceUtil
...
public interface regiontableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link regiontableLocalServiceUtil} to access the regiontable local service. Add custom service methods to {@link userapi.service.impl.regiontableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<regiontable> getregiontables(int start, int end);
	...
	*/
	...
	public regiontable addregiontable(regiontable regiontable);
	...
	*/
	public regiontable createregiontable(int region_id);
	...
	*/
	...
	public regiontable deleteregiontable(int region_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public regiontable deleteregiontable(regiontable regiontable);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public regiontable fetchregiontable(int region_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public regiontable getregiontable(int region_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public regiontable updateregiontable(regiontable regiontable);
}