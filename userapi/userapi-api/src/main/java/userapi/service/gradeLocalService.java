...
/**
 * Provides the local service interface for grade. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see gradeLocalServiceUtil
...
public interface gradeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link gradeLocalServiceUtil} to access the grade local service. Add custom service methods to {@link userapi.service.impl.gradeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<grade> getgrades(int start, int end);
	...
	*/
	public grade creategrade(int grade_id);
	...
	*/
	...
	public grade deletegrade(int grade_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public grade fetchgrade(int grade_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public grade getgrade(int grade_id) throws PortalException;
