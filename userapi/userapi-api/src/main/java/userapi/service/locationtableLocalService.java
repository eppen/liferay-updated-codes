...
/**
 * Provides the local service interface for locationtable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see locationtableLocalServiceUtil
...
public interface locationtableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link locationtableLocalServiceUtil} to access the locationtable local service. Add custom service methods to {@link userapi.service.impl.locationtableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
