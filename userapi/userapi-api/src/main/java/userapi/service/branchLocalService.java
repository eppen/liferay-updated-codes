 ...
 * @see userapi.service.base.branchLocalServiceBaseImpl
 * @see userapi.service.impl.branchLocalServiceImpl
 * @generated
 */
@ProviderType
...
public interface branchLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link branchLocalServiceUtil} to access the branch local service. Add custom service methods to {@link userapi.service.impl.branchLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public branch createbranch(int branch_id);
	...
	*/
	...
	public branch deletebranch(int branch_id) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public branch fetchbranch(int branch_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public branch getbranch(int branch_id) throws PortalException;
