...
/**
 * Provides the local service interface for jvbranch. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see jvbranchLocalServiceUtil
...
public interface jvbranchLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link jvbranchLocalServiceUtil} to access the jvbranch local service. Add custom service methods to {@link userapi.service.impl.jvbranchLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<jvbranch> getjvbranchs(int start, int end);
	...
	*/
	...
	public jvbranch addjvbranch(jvbranch jvbranch);
	...
	*/
	public jvbranch createjvbranch(int jvbranch_id);
	...
	*/
	...
	public jvbranch deletejvbranch(int jvbranch_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public jvbranch deletejvbranch(jvbranch jvbranch);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public jvbranch fetchjvbranch(int jvbranch_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public jvbranch getjvbranch(int jvbranch_id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public jvbranch updatejvbranch(jvbranch jvbranch);
}