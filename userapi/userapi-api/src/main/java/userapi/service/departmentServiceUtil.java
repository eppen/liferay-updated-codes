 ...
 * {@link userapi.service.impl.departmentServiceImpl} and is the
...
public class departmentServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link userapi.service.impl.departmentServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	private static ServiceTracker<departmentService, departmentService> _serviceTracker =
		ServiceTrackerFactory.open(departmentService.class);
}