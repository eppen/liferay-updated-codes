 ...
 * {@link userapi.service.impl.branchLocalServiceImpl} and is the
...
public class branchLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link userapi.service.impl.branchLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<userapi.model.branch> getbranchs(int start,
		int end) {
	...
	*/
	public static userapi.model.branch addbranch(userapi.model.branch branch) {
	...
	*/
	public static userapi.model.branch createbranch(int branch_id) {
		return getService().createbranch(branch_id);
	}
	...
	*/
	public static userapi.model.branch deletebranch(int branch_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletebranch(branch_id);
	}
	...
	* @return the branch that was removed
	*/
	public static userapi.model.branch deletebranch(userapi.model.branch branch) {
		return getService().deletebranch(branch);
	}

	public static userapi.model.branch fetchbranch(int branch_id) {
		return getService().fetchbranch(branch_id);
	}
	...
	* @throws PortalException if a branch with the primary key could not be found
	*/
	public static userapi.model.branch getbranch(int branch_id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getbranch(branch_id);
	}
	...
	*/
	public static userapi.model.branch updatebranch(userapi.model.branch branch) {
	...
	private static ServiceTracker<branchLocalService, branchLocalService> _serviceTracker =
		ServiceTrackerFactory.open(branchLocalService.class);
}