...
/**
 * Provides the local service interface for functiontable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see functiontableLocalServiceUtil
...
public interface functiontableLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link functiontableLocalServiceUtil} to access the functiontable local service. Add custom service methods to {@link userapi.service.impl.functiontableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<functiontable> getfunctiontables(int start, int end);
	...
	*/
	...
	public functiontable addfunctiontable(functiontable functiontable);
	...
	*/
	public functiontable createfunctiontable(int function_id);
	...
	*/
	...
	public functiontable deletefunctiontable(int function_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public functiontable deletefunctiontable(functiontable functiontable);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public functiontable fetchfunctiontable(int function_id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public functiontable getfunctiontable(int function_id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public functiontable updatefunctiontable(functiontable functiontable);
}