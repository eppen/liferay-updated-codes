 ...
 * @see userapi.service.persistence.impl.departmentPersistenceImpl
 * @generated
 */
@ProviderType
public class departmentUtil {
	...
	*/
	public static department create(int dept_id) {
	...
	*/
	public static department remove(int dept_id)
		throws userapi.exception.NoSuchdepartmentException {
	...
	* @throws NoSuchdepartmentException if a department with the primary key could not be found
	*/
	public static department findByPrimaryKey(int dept_id)
		throws userapi.exception.NoSuchdepartmentException {
	...
	*/
	public static department fetchByPrimaryKey(int dept_id) {
