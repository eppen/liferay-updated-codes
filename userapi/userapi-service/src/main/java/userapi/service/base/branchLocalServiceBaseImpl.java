...
import userapi.service.branchLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link userapi.service.impl.branchLocalServiceImpl}.
 * </p>
 *
...
public abstract class branchLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link userapi.service.branchLocalServiceUtil} to access the branch local service.
	 */
	...
	public branch createbranch(int branch_id) {
		return branchPersistence.create(branch_id);
	}
	...
	public branch deletebranch(int branch_id) throws PortalException {
		return branchPersistence.remove(branch_id);
	}
	...
	public branch fetchbranch(int branch_id) {
		return branchPersistence.fetchByPrimaryKey(branch_id);
	}
	...
	public branch getbranch(int branch_id) throws PortalException {
		return branchPersistence.findByPrimaryKey(branch_id);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("userapi.model.branch",
			branchLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister("userapi.model.branch");
	}
